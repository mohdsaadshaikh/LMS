...
function MembersList(props: {
  ...
  return (
    <Show when={props.membersData()} fallback={<Loader />}>
      {(res) => (
        <div class="overflow-x-auto border border-black bg-white w-full h-[60vh] md:w-[90vw] lg:w-[80vw] ">
          <table class="bg-white">
            <thead class="bg-gray-100 whitespace-nowrap">
              <tr>
                ...
                <th class="p-4 text-left text-sm font-medium">Qualification</th>
                  ...
                  <tr class="hover:bg-gray-50">
                    <td class="p-4 text-sm text-slate-900 font-medium">
                      <div class="flex items-center cursor-pointer w-max">
                        <div class="w-9 h-9 rounded-full bg-blue-500 flex items-center justify-center text-white font-semibold text-sm shrink-0">
          ...
          <div class="flex flex-col md:flex-row items-center justify-between gap-4 p-4 border-t border-gray-200">
            <Pagination.Root
              count={res()?.total || 0}
                ...
                {(api) => (
                  <div class="flex flex-col md:flex-row items-center gap-6 w-full justify-between">
                    <div class="flex items-center gap-2 text-sm text-gray-600">
                      ...
                      <select
                        class="border px-2 py-1 text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                        value={api().pageSize}
                        onChange={(e) =>
                    ...
                    <div class="flex items-center gap-1">
                      <Pagination.PrevTrigger class="px-3 py-1  border text-sm text-gray-700 hover:bg-gray-100 disabled:opacity-50">
                        Previous
                      ...
                      <Pagination.NextTrigger class="px-3 py-1 border text-sm text-gray-700 hover:bg-gray-100 disabled:opacity-50">
                        Next
